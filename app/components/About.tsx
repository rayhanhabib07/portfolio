      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-5 gap-12 items-start">
          <div className="md:col-span-2 flex justify-center md:justify-start">
            <div className="w-56 h-56 sm:w-64 sm:h-64 rounded-2xl border border-[#E5E7EB] bg-[#F4F4F5] overflow-hidden">
              <Image
                src="/photo.png"
                alt="Shadhin"
                width={256}
          ...
          <div className="md:col-span-3">
            <p className="text-sm font-medium text-[#4A90E2] mb-3 tracking-wide">About</p>
            <h2 id="about-heading" className="text-3xl sm:text-4xl font-bold text-[#1B2631] mb-6">
              Hey, I&apos;m Shadhin.
            </h2>
            ...
            <div className="flex items-center gap-5 mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#9CA3AF] hover:text-[#1B2631] transition-colors duration-200"
